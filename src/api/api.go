...
import (
	...
	"github.com/SajjadRezaei/go-clean-architecture/api/router"
	validation "github.com/SajjadRezaei/go-clean-architecture/api/validation"
	"github.com/SajjadRezaei/go-clean-architecture/config"
	"github.com/SajjadRezaei/go-clean-architecture/docs"
